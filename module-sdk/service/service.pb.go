...
type Params struct {
	...
	MinDeposit           github_com_irisnet_irishub_sdk_go_types.Coins `protobuf:"bytes,3,rep,name=min_deposit,json=minDeposit,proto3,castrepeated=github.com/irisnet/irishub-sdk-go/types.Coins" json:"min_deposit"`
	ServiceFeeTax        github_com_irisnet_irishub_sdk_go_types.Dec   `protobuf:"bytes,4,opt,name=service_fee_tax,json=serviceFeeTax,proto3,customtype=github.com/irisnet/irishub-sdk-go/types.Dec" json:"service_fee_tax" yaml:"service_fee_tax"`
	SlashFraction        github_com_irisnet_irishub_sdk_go_types.Dec   `protobuf:"bytes,5,opt,name=slash_fraction,json=slashFraction,proto3,customtype=github.com/irisnet/irishub-sdk-go/types.Dec" json:"slash_fraction" yaml:"slash_fraction"`

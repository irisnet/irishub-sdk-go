...
type MsgRequestRand struct {
	Consumer      original.AccAddress `json:"consumer"`        // request address
...
// Implements Msg.
func (msg MsgRequestRand) GetSigners() []original.AccAddress {
...
type request struct {
	...
	Consumer      original.AccAddress `json:"consumer"`        // the request address

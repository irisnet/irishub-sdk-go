...
```bash
go test -v --bench github.com/irisnet/irishub-sdk-go/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/irisnet/irishub-sdk-go/crypto/keys/mintkey
...
PASS
ok  	github.com/irisnet/irishub-sdk-go/crypto/keys/mintkey	12.093s
```
